...
## Step 1 — Open the Build experience

1. Open Azure AI Foundry and select project `lab-project-001`.
2. Select **Build** in the top navigation.
3. Select **Build an agent**.

![Foundry Build page with Build an agent](./assets/16-click-build.png)

## Step 2 — Create a prompt agent

1. In the left navigation, select **Agents**.
2. Select **New agent**.
3. Select **Build an agent** rather than **Code an agent**.
...
1. Enter a unique name, for example `LAB-SOC-AGENT`.
2. Select **Create**.
3. Wait until the agent editor loads.

![Name and create the Investigation Agent](./assets/19-name-new-agent-and-create.png)

The editor opens with an empty instruction field and a **Tools** section.

![New agent editor](./assets/20-new-agent-ready.png)

## Step 4 — Select a model

1. In the model selector, choose the project deployment available to you. The lab screenshots use `gpt-5.6-sol`; another approved project deployment is acceptable.
2. Leave **Voice mode** off for this workshop.

## Step 5 — Attach SentinelMCP
...
## Step 8 — Paste the agent instructions
...
## Step 10 — Run a basic validation
...
## Step 11 — Run a deep-investigation validation
